...
import { addCar, updateCar } from '@/services/car.service'
...
type CarForm = z.infer<typeof formSchema>
...
export function CarsActionDialog({ currentRow, open, onOpenChange }: Props) {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: isEdit ? updateCar : addCar,
    onSuccess: (data) => {
  ...
  const onSubmit = (values: CarForm) => mutate(isEdit ? { id: currentRow.id, ...values } : values)
